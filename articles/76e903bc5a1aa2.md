...
:::message alert
React Query v4.0.0-beta.9よりQuery Functionからundefinedを返すことができなくなりました。記事のソースコードに問題はありませんがbeta.9〜10ではその影響で型エラーが出るようです。こちらはissueとして報告済みのため近々に解消されると思われます。なおbeta8以前もしくはv3では問題なく動作します。
- https://github.com/tannerlinsley/react-query/pull/3541

**2022/6/3追記**  
解決に時間がかかりそうということで、Beta.20から上記機能はいったん削除となりました。
- https://github.com/tannerlinsley/react-query/releases/tag/v4.0.0-beta.20
:::
