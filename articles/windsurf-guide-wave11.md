...
**Voice Mode（音声モード）**
Cascade との対話に音声インターフェースが導入され、複雑な要求や長い説明を自然な話し言葉で伝えることができるようになりました。
...
Wave 11 では、この機能がデフォルトで有効になりました[^3]。Planning Mode を使用することで、以下のような品質向上が期待できます：
