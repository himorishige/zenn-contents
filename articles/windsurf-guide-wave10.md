...
> *引用元：[Windsurf Launch](https://windsurf.com/blog/windsurf-launch)*
...
AI との共同作業でしばしば課題となるのが「AI ドリフト」です。これは、対話を重ねるうちに AI の応答が当初の目的や文脈から少しずつズレていってしまう現象を指します。このドリフトを防ぎ、開発の主導権を人間が握り続けるために、私はWindsurf を利用する際に以下の手法で対応しています。
