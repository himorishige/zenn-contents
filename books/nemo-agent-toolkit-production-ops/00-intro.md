...
- **第 14 章**で 4 本柱を統合し、**第 15 章**で multi-agent への拡張（supervisor pattern）を扱います。第 15 章は本書のスコープを少し超える応用ですが、production 移行時に自然と登場するパターンです
...
graph TD
    ...
    C14 --> C15["第15章<br/>Multi-agent 拡張"]
